const HITOS = [
  {
    ...
    texto:  "Me acuerdo mucho de este día, donde esta era nuestra segunda cita, y qué mejor que haciendo deporte jeje. Ese día iba con toda la personalidad para poder explicarte que quería ser algo más que \u201Camigos\u201D, pero en el buen sentido, ya que de verdad estaba muy enganchado a ti en estas fechas. Algo que recuerdo con mucho cariño era la tensión que había entre nosotros dos al bajar el sendero, y para finalizar el día, terminó de una forma bakán comiendo McDonald\u2019s SJASKSAA. Había que recuperar esas calorías quemadas deaaa.",
    foto:   "fotos/1.jpg",
    icono:  "💛"
  },
  {
  ...
  },
  {
    fecha:  "18 · 05 · 2026",
    titulo: "UN MES",
    texto:  "Nuestro primer cumple mes fue un lunes, un día que fue muy ajetreado para ambos, pero que recuerdo con mucho cariño, ya que a pesar de todo el cansancio acumulado por detrás, nos dimos el tiempo de tener una linda cita, donde fuimos a jugar juegos, nos sacamos fotos y comimos rico. En este momento ambos teníamos nuestros regalos jeje, y fue un momento muy emocionante, ya que es algo nuevo el poder recibir este tipo de regalos y ver todo lo que hiciste: cada recorte pegado de manera precisa, tus bellas palabras, y el lindo gesto de pegar una de las fotos en el regalo (también había pensado en ello JSJSAJSJA). Hace de verdad muy lindo el gesto, mi chica catan bella preciosa. Es bonito el sentimineto y espero poder hacer hacerte sentir lo mismo.",
    foto:   "fotos/5.jpg",
    icono:  "💛"
  },
  
  {
    ...
    texto:  "Bueno, ya siendo 18 de julio de 2026, hoy se cumplen 3 meses de que iniciamos nuestra relación, y de verdad no tengo palabras para poder agradecerte por estos 3 meses, donde he tenido la fortuna de vivir momentos inolvidables junto a ti! Desde poder seguir conociendo a tu familia, y yo a la tuya, nuevas escapadas de fin de semana, y un monton de pequeños gestos que cada dia me hacen sentir muy amado de tu parte. En estas fechas no pudimos estar juntos para celebrar como se debe, pero los fines de semana anteriores los quería hacer especiales en honor a ti y a nuestra relación. Por eso mismo, hago entrega de este camino de recuerdos, el cual servirá para poder recordar algunos momentos en los cuales me he sentido amado, escuchado, feliz, emocionado, extasiado y un millón de cosas que no sabría cómo describir. Pero en resumen: me siento el hombre más afortunado de la faz de la tierra, y es todo un honor ser tu pololo,y aunque estemos a 13.400, 14 u 899 km, siempre trataré de ser el hombre que mereces hoy y siempre, porque eso es lo que merece alguien como tú, mi bella y dulce karlirta. La amo muchísimo mi corazón mío <3",
    foto:   "fotos/hoy.jpg",
    icono:  "💛"
  }
];
